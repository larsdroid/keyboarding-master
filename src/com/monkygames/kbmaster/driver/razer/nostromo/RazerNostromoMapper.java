...
import com.monkygames.kbmaster.driver.Mapper;

/**
 * Maps.
 * @version 1.0
 */
public class RazerNostromoMapper implements Mapper{
...
// ============= Static Methods ============== //
	...
	keymap.setMiddleWheelMapping(new WheelMapping(new Wheel(23),new OutputMouse("Middle-Click",InputEvent.BUTTON3_MASK,MouseType.MouseClick)));
	return keymap;
    }
    @Override
